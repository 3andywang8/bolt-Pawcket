            ...
            <View style={styles.optionRow}>
              {[
                ...
                <TouchableOpacity
                  ...
                  style={[
                    styles.optionButton,
                    filters.animalType === option.key && styles.optionButtonActive,
                  ]}
                  ...
                  <Text
                    style={[
                      styles.optionText,
                      filters.animalType === option.key && styles.optionTextActive,
                    ]}>
                    {option.label}
                  </Text>
                </TouchableOpacity>
            ...
            <View style={styles.optionRow}>
              {[
                ...
                <TouchableOpacity
                  ...
                  style={[
                    styles.optionButton,
                    filters.ageGroup === option.key && styles.optionButtonActive,
                  ]}
                  onPress={() => updateFilter('ageGroup', option.key as any)}>
                  <Text
                    style={[
                      styles.optionText,
                      filters.ageGroup === option.key && styles.optionTextActive,
                    ]}>
                    {option.label}
                  </Text>
                </TouchableOpacity>
